...
## Problem Description
You will simply to a GET to `https://868r1t0.restletmocks.net/catfish` and use that data to form different views. There will be no need to perform the other CRUD operations for this since we are more interested in your ability to use the React Redux flow and the React lifecycle properly to build a fairly complex page.
...
With a list of these DTOs you will create a set of UI components that allow the user to interact with the data. Styling and layout are not important on this kata, so you do not need to waste time worrying about that. You may if you wish bring in HTML component tools to help solve the problems.
...
The third component will allow the user to select an species and get the average weight, the average length, and the average girth. It will also display the standard deviation of weight (https://www.mathsisfun.com/data/standard-deviation-formulas.html).

The final component display the top 5 fish records by weight aggregated by species.
